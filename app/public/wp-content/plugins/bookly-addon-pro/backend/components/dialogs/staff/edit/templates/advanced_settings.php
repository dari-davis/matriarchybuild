...
?>
<form>
    <div class="form-group <?php if (!is_admin()): ?>d-none<?php endif; ?>">
    ...
    <div class="form-group bookly-js-icalendar-feed <?php if (!is_admin()): ?>d-none<?php endif; ?>">
    ...
    <div class="border-left ml-4 pl-3 <?php if (!is_admin()): ?>d-none<?php endif; ?>"<?php echo $staff->getICalendar() ? '' : ' style="display: none"' ?> id="bookly-icalendar-days-offset">
    ...
    <div class="<?php if (!is_admin()): ?>d-none<?php endif; ?>">
