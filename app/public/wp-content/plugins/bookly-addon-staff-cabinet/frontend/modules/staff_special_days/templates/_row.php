...
<div class="bookly-js-range-row ssd_id-<?php echo $day['id'] ?>">
    <div class="form-row py-1 rounded-lg mb-1">
        <div class="col-lg-3">
            <div>
                <input style="width: auto;" class="form-control bookly-js-date mb-2 mb-lg-0" type="text" name="list[<?php echo $day['id'] ?>][date]" value="<?php echo $day['date'] !== null ? \Bookly\Lib\Utils\DateTime::formatDate( $day['date'] ) : '' ?>" data-date="<?php echo $day['date'] ?>" autocomplete="off">
