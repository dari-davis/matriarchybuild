...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220106_matriarchybuild_322893abdbe4ad8b4850_20220106141841_archive.zip';
	const ARCHIVE_SIZE		 = '34767211';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '322893a-06141841';
    const SECONDARY_PACKAGE_HASH = '3978b86-06141841';
	const VERSION			 = '1.4.3';
