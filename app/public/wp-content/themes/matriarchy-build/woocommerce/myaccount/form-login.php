...
<div class="my-account__wrapper">
	<div class="row no-gutters" id="customer_login">
		...
		<div class="col-md-6 mb-3 mb-md-0 pb-5 mb-borders--right pe-md-3">
			...
			<form class="woocommerce-form woocommerce-form-login login mt-3 mb-3 mb-md-0" method="post">
				...
				<p class="form-row">
					...
					<a class="d-flex pb-3" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Forgot your password?', 'woocommerce' ); ?></a>
		...
		<div class="col-md-6 mb-3 mb-md-0 pb-5 ps-md-3">
			...
			<a href="/my-account/create-account" class="button alt"><?php esc_html_e('Create a New Account', 'woocommerce' ); ?></a>
		</div>
