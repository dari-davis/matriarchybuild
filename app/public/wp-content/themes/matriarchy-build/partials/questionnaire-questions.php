...
<form class="questionnaire px-4 py-5" method="post">
    ...
    <?php if( empty(get_post_meta($order_id, 'answer1'))): ?>
        <div class="questionnaire__questions">
            ...
            <div class="d-flex p-3 align-items-center"><button type="submit" value="Save" name="submit" class="w-auto button">Save</button><p class="ms-4 mb-0">Please submit your questionnaire before starting Step 2.</p></div>
        </div>
    <?php endif; ?>
</form>