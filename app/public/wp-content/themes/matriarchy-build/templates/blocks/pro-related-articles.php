            ...
            <?php foreach ($articles as $article):
                ...
                <div class="article col-md-6 mt-3 mb-3 mb-md-5 <?= count($articles) == 1 ? 'col-md-8' : ''; ?>">
                    <div class="article__details col p-0 mb-borders">
                        ...
                        <a class="article__name" href="<?= $permalink; ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'matriarchy-build' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" aria-label="<?= $article->post_title; ?>"><div class="article__title p-2"><?= $article->post_title; ?></div></a>
                    </div>
