...
<div class="how-it-works d-lg-flex flex-column<?php if (!$page): ?> content-block" style="background-color: <?= get_field('background_color'); ?>;<?php endif; ?>">
        ...
        <div class="how-it-works__content how-it-works__slides row gx-0">
            <?php if (have_rows('steps')): ?>
                <?php while (have_rows('steps')): the_row(); ?>
                    <div class="how-it-works__section mb-borders <?php if ($page): ?>d-flex<?php endif; ?>" style="background-color: <?= get_field('active_step_background_color'); ?>;">
                        <div class="how-it-works__top <?php if ($page): ?>d-md-flex col-md-6<?php else: ?>d-lg-flex<?php endif; ?>">
                            <div class="how-it-works__step">Step <?= get_row_index(); ?><img class="d-none <?php if ($page): ?>d-md-inline<?php else: ?>d-lg-inline<?php endif; ?>" src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/arrow_blue_medium.svg" alt="blue arrow"/></div>
